    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center px-4">
      <GlassCard className="w-full max-w-md" hover={false}>
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Start predicting and preventing hypos</p>
        </div>

        <form onSubmit={handleRegister} className="space-y-4">
          <div className="relative">
            <User className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
            <Input placeholder="Full Name" value={name} onChange={(e) => setName(e.target.value)} className="pl-10 bg-secondary border-border rounded-xl" required />
          </div>
          <div className="relative">
          ...
          <div className="relative">
            ...
            <Input type="password" placeholder="Password (min 6 chars)" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 bg-secondary border-border rounded-xl" required minLength={6} />
          </div>
        ...
        <Button onClick={handleGoogleRegister} variant="outline" className="w-full rounded-xl border-border">
